...
OUTPUT_DIR = DEV_ROOT / "03_RESULTADOS"
DB_CORE5_PATH = OUTPUT_DIR / "02_DADOS_ESTRUTURADOS" / "memoria_core5_forense.db"
CORE5_REPORT_MD = OUTPUT_DIR / "01_INDICES_E_RELATORIOS" / "RELATORIO_MESTRE_CORE5_FORENSE.md"

sys.path.append(str(DEV_ROOT / "02_MOTOR_FORENSE" / "10_CORE5_SUPER_MOTOR"))
...
class MotorSuperForenseCore:
    ...
    def executar_orquestracao_global(self):
        ...
        target_dirs = [
            ...
            OUTPUT_DIR / "01_INDICES_E_RELATORIOS"
        ]
