# Reasoning Contract (T0 a T8) - Especificacao Operacional

Este documento estabelece o contrato formal de raciocinio e etapas operacionais obrigatorias para todos os agentes de IA que operam no acervo canonico e no ecossistema Dev.
...
| **T6** | **Motor de 4 Camadas** | Cruzamento quadridimensional: **Prova $\times$ Alegacao $\times$ Norma $\times$ Decisao/Impacto** (abrange artigos de lei, jurisprudencia, despachos, custas e posse). |
