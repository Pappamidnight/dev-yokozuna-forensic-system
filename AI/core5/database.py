...
DB_CORE5_PATH = DEV_ROOT / "OUTPUT_CENTRALIZADO" / "02_DADOS_ESTRUTURADOS" / "memoria_core5_forense.db"
...
def inicializar_banco_core5():
    ...
    CREATE TABLE IF NOT EXISTS entities (
        ...
        nome TEXT NOT NULL,
        tipo TEXT, -- PESSOA, EMPRESA, TRIBUNAL, AGENTE_EXECUCAO, MANDATARIO
        nif TEXT,
    ...
    CREATE TABLE IF NOT EXISTS events (
        ...
        process_id TEXT,
        data_evento TEXT,
        tipo_evento TEXT, -- CITACAO_DEVOLVIDA, DESPACHO_INDEFERIMENTO, CORTE_AGUA, PENHORA, ACORDAO_EXTINCAO
        entidade_origem TEXT,
        documento_fonte TEXT,
        sha256 TEXT,
        forca_probatoria TEXT, -- OFICIAL, ALTA, MEDIA, BAIXA
        estado_validacao TEXT, -- DOCUMENTADO, NECESSITA_VALIDACAO
    ...
    CREATE TABLE IF NOT EXISTS relations (
        ...
        entity_a TEXT,
        entity_b TEXT,
        tipo_relacao TEXT, -- LOCADOR_LOCATARIO, EXEQUENTE_EXECUTADO, SOCIO_GERENTE, COACAO_HABITACIONAL
        detalhes TEXT
    )
    """)
    ...
    CREATE TABLE IF NOT EXISTS actions (
        ...
        estado TEXT, -- PRONTA, PENDENTE, CONCLUIDA
        peca_destino TEXT
    )
    """)
