# Validacao De Conflito - 423d4237715547eb56b3

Chave: `Registo::ibiHg6umCqvcTF4g::nodes`
Detectado em: 2026-05-13T00:10:13+01:00

## Informacao Confirmada

```json
{
  "key": "Registo::ibiHg6umCqvcTF4g::nodes",
  "entity_type": "Registo",
  "entity_id": "ibiHg6umCqvcTF4g",
  "field": "nodes",
  "value": [
    {
    ...
    },
    {
      ...
      "parameters": {
        ...
        "width": 1400,
        "height": 240,
        "content": "# STEP 5\n\n## Add Widget\n\nAdd the widget to your business website by replacing AGENT_ID with the agent id you created on ElevenLabs\n\n<elevenlabs-convai agent-id=\"AGENT_ID\"></elevenlabs-convai><script src=\"{{ $env.WEBHOOK_URL }}\" async type=\"text/javascript\"></script>"
      },
      "typeVersion": 1,
      "notes": "This stickyNote node performs automated tasks as part of the workflow."
    }
  ],
  "value_hash": "a79dd52799fe830b4c1fc5dadc42261a8fe83dd2f9ac174619e49e4192e623fa",
  "source_path": "C:\\Users\\nunom\\1\\n8n-workflows\\workflows\\Webhook\\1263_Webhook_Respondtowebhook_Automate_Webhook.json",
  "source_file_hash": "3e1c5346ff907510b01aa43b9d429f8df34f3d981ea559f90b2d25bdee3f529d",
  "confidence": 0.8,
  "status": "confirmed"
}
```
...
```json
{
  ...
  "value_hash": "3db7f626c5e2d9c89685c64bcd6bf518dbbb9723751251421e6990b9d4fcb149",
  "source_path": "C:\\Users\\nunom\\1\\n8n-workflows\\workflows\\Webhook\\1887_Webhook_Respondtowebhook_Automate_Webhook.json",
  "source_file_hash": "f397ddb11f8e6ca7f35bbb7af930394b5e1fe07929a4e69f3e6883f131fd45bd",
  "confidence": 0.8,
  "metadata": {
    "input_format": ".json"
  },
  "confirmed_at": "2026-05-13T00:10:13+01:00",
  "status": "confirmed"
}
```
...
```powershell
python tools\ingest_compact_validate.py resolve --conflict-id 423d4237715547eb56b3 --choice existing
python tools\ingest_compact_validate.py resolve --conflict-id 423d4237715547eb56b3 --choice incoming
```

Escolhas: `existing` mantem confirmado; `incoming` substitui; `merge` guarda nota manual.
