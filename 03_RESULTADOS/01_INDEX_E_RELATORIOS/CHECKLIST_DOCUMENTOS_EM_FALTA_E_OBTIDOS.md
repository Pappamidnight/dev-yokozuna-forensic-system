# Checklist Forense: Documentos Obtidos vs. Documentos em Falta para Junção aos Autos
...
**Objetivo**: Identificação cirúrgica de todas as provas já asseguradas e dos últimos documentos a obter para fecho total dos processos.

---

## 1. O Que Já Temos 100% Assegurado no Computador (Auditado e Válido)
...
2. `[ ]` **Cópia Integral em PDF do Acórdão do TRL**:
   - Já temos a comunicação oficial dos advogados (FLRP), mas a certidão eletrónica extraída do Citius pelo mandatário deve ser anexada ao requerimento.
...
4. `[ ]` **Extratos Bancários dos Pagamentos das Obras ao António Neto**:
   - Os comprovativos de transferência bancária dos valores listados em `LEA_fornc.pdf` (para juntar à prova do crédito de benfeitorias do **Direito de Retenção — Art. 754.º CC**).
...
6. `[ ]` **Comprovativo de Concessão de Apoio Judiciário da Segurança Social**:
   - Se requereu apoio judiciário na Segurança Social, a certidão do deferimento deve acompanhar a queixa para isenção total de taxa de justiça.

---

## 3. Resumo de Prontidão

| Processo / Ação | Grau de Cobertura Documental | Estado |
|---|---|---|
| **Proc. 23142/22 (Levantamento de Penhoras)** | **95%** (Só falta o comprovativo do seu IBAN) | Pronto a entregar |
| **Proc. 3719/25 (Contra-Alegações no TRL)** | **90%** (Vídeos, Galp e WhatsApp já prontos) | Pronto a entregar |
| **Proc. 15547/26 (Defesa na Reivindicação)** | **85%** (Contratos, Cadernetas e Balanço prontos) | Pronto para instrução |
| **Queixas-Crime no MP e CAAJ** | **95%** (Peças redigidas com fundamentação penal) | Pronto para assinatura |
